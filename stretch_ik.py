...
target_point = [0.0, -0.8, 1.1]
target_point2 = [0.0, -0.551, 1.1]
...
# time.sleep(5)
# move_to_grasp_goal(target_point2, target_orientation, pretarget_orientation)
